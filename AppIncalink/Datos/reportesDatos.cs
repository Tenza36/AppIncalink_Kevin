...
namespace AppIncalink.Datos
{
    public class reportesDatos
    {
                        ...
                        .Element(element =>
                        {
                            element.Row(row =>
                            {
                                row.RelativeColumn()
                                    .AlignCenter()
                                    .AlignMiddle()
                                    .Text("Listado de Actividades de Menu por Grupo")
                                    .FontSize(20)
                                    .Bold();
                            });
                        });
        ...
        public MemoryStream GenerateVehiculoPdf(List<MenuPorVehiculoModel> actividades)
        {
            var pdfStream = new MemoryStream();
                        ...
                        .Element(element =>
                        {
                            element.Row(row =>
                            {
                                row.RelativeColumn()
                                    .AlignCenter()
                                    .AlignMiddle()
                                    .Text("Listado de Actividades de Vehiculos por Grupo")
                                    .FontSize(20)
                                    .Bold();
                            });
                        });
                    ...
                    page.Content()
                        .Table(table =>
                        {
                            ...
                            table.Header(header =>
                            {
                                var headerCells = new string[]
                                {
                            "Nombre de la Actividad", "Nombre del Grupo", "Fecha de Inicio", "Fecha Final", "Recursos", "Responsable", "Lugar Desde", "Lugar Hacia", "Observaciones", "Vehiculo"
                                };
                            ...
                            foreach (var actividad in actividades)
                            {
                                ...
                                table.Cell()
                                    ...
                                    .Padding(5)
                                    .AlignCenter() // Alinea el texto al centro
                                    .Element(CellText => CellText.Text(actividad.Lugar));
                            }
                        });
        ...
        public MemoryStream GenerateTipoActividadPdf(List<tipoActividadPorGrupoModel> actividades)
        {
            var pdfStream = new MemoryStream();
                        ...
                        .Element(element =>
                        {
                            element.Row(row =>
                            {
                                row.RelativeColumn()
                                    .AlignCenter()
                                    .AlignMiddle()
                                    .Text("Listado de Actividades de Tipo de Actividad por Grupo")
                                    .FontSize(20)
                                    .Bold();
                            });
                        });
                    ...
                    page.Content()
                        .Table(table =>
                        {
                            ...
                            table.Header(header =>
                            {
                                var headerCells = new string[]
                                {
                            "Nombre de la Actividad", "Nombre del Grupo", "Fecha de Inicio", "Fecha Final", "Recursos", "Responsable", "Lugar Desde", "Lugar Hacia", "Observaciones", "Tipo de Actividad"
                                };
                            ...
                            foreach (var actividad in actividades)
                            {
                                ...
                                table.Cell()
                                    ...
                                    .Padding(5)
                                    .AlignCenter() // Alinea el texto al centro
                                    .Element(CellText => CellText.Text(actividad.tipoActividad));
                            }
                        });
